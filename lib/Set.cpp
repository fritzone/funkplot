...
QVector<QSharedPointer<Statement>> Set::create(int ln, const QString &codeline, QStringList &codelines, StatementCallback cb, StatementReaderCallback srcb)
{
    ...
    sett->what = what;
    sett->value = to_what;
    return handleStatementCallback( vectorize( sett ), cb);
}
